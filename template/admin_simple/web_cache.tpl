...
?>
			...
			<tr>
				...
				<td class="row" colspan="3"><br />
					...
					<br /><br />
					<input class="btn" type="button" onclick="cclean()" value=" 清 理 " />
					&nbsp;&nbsp; 
					<span class="comment">清理缓存所占用的磁盘空间，也可以使相关更改立即生效</span><br /><br />
				</td>
			</tr>
			<tr>
				<td class="cat">页面缓存</td>
				<td class="row" colspan="3"><br />
					...
					&nbsp;&nbsp; 
					<span class="comment">开启页面缓存，减少固定时间内的查询频率，增强网站效率</span><br /><br />
				</td>
			</tr>
		</table>
	</form>
