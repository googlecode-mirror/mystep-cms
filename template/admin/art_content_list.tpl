...
<div align="center">
	<table id="list_area" cellSpacing="0" cellPadding="0" align="center">
		<tr align="center"> 
			<td class="cat" width="30"><a href="?keyword=<!--keyword-->&cat_id=<!--cat_id-->&order_type=<!--order_type-->"><font color="#000000">编号</font></a></td>
			<td class="cat" width="60"><a href="?keyword=<!--keyword-->&order=cat_id&order_type=<!--order_type-->&cat_id=<!--cat_id-->"><font color="#000000">栏目</font></a></td>
			<td class="cat"><a href="?keyword=<!--keyword-->&order=subject&order_type=<!--order_type-->&cat_id=<!--cat_id-->"><font color="#000000">文章标题</font></a></td>
			<td class="cat" width="80"><a href="?keyword=<!--keyword-->&order=add_user&order_type=<!--order_type-->&cat_id=<!--cat_id-->"><font color="#000000">录入人</font></a></td>
			<td class="cat" width="120"><a href="?keyword=<!--keyword-->&order=add_date&order_type=<!--order_type-->&cat_id=<!--cat_id-->"><font color="#000000">录入日期</font></a></td>
...
<!--loop:start key="record" time="20"-->
		<tr align="center">
			...
			<td class="row">
				<a href="?method=unlock&news_id=<!--record_news_id-->">解锁</a>
				<a href="?method=edit&news_id=<!--record_news_id-->">修改</a>
				<a href="?method=delete&news_id=<!--record_news_id-->" onclick="return confirm('是否确定要删除该文章？')">删除</a>
			</td>
		</tr>
<!--loop:end-->
	</table>
