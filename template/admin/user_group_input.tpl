...
<!--loop:start key="power_cat"-->
					<input type="checkbox" onclick="checkStatus('power_cat')" id="power_cat_<!--power_cat_cat_id-->" class="cbox" webid="<!--power_cat_web_id-->" name="power_cat[]" value="<!--power_cat_cat_id-->" <!--power_cat_checked-->><label for="power_cat_<!--power_cat_cat_id-->"> <!--power_cat_cat_name--></label> <br />
<!--loop:end-->
				</td>
			</tr>
			<tr> 
