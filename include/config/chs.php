...
$setting_comm['rewrite_comm'] = 'URL Rewrite 规则设置';
$setting_comm['rewrite']['enable'] = '静态连接';
$setting_comm['rewrite']['read'] = '文章页面';
$setting_comm['rewrite']['list'] = '分类页面';
$setting_comm['rewrite']['tag'] = '标签页面';
$setting_comm['rewrite_descr']['enable'] = '将网站链接转换为静态连接，需服务器开启 URL_Rewrite 支持';
$setting_comm['rewrite_descr']['read'] = '文章页网址rewrite索引';
$setting_comm['rewrite_descr']['list'] = '列表页网址rewrite索引';
$setting_comm['rewrite_descr']['tag'] = '标签页网址rewrite索引';
...
$setting_type['rewrite']['enable'] = array("radio", array("开启"=>"true", "关闭"=>"false"));
