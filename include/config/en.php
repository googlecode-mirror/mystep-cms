...
$setting_comm['watermark']['txt'] = 'Interference String';
$setting_comm['watermark']['img'] = 'Watermark Content';
$setting_comm['watermark']['position'] = 'Watermark Position';
$setting_comm['watermark']['img_rate'] = 'Watermark Rate';
$setting_comm['watermark']['txt_font'] = 'Watermark Font';
$setting_comm['watermark']['txt_fontsize'] = 'Watermark Font Size';
$setting_comm['watermark']['txt_fontcolor'] = 'Watermark Font Color';
$setting_comm['watermark']['txt_bgcolor'] = 'Watermark Font Background Color';
$setting_comm['watermark']['alpha'] = 'Watermark Transparent Level';
$setting_comm['watermark']['credit'] = 'Credit Infor.';
$setting_comm['watermark_descr']['mode'] = 'Add Watermark to artile content or images';
$setting_comm['watermark_descr']['txt'] = 'Interference String will be added to artile content';
$setting_comm['watermark_descr']['img'] = 'Image or any text that will be added to images';
$setting_comm['watermark_descr']['position'] = 'Where to put the watermark';
$setting_comm['watermark_descr']['img_rate'] = 'Control the size of Watermark image';
$setting_comm['watermark_descr']['txt_font'] = 'The font file for the text watermark';
$setting_comm['watermark_descr']['txt_fontsize'] = 'The size of text watermark, in pixal';
$setting_comm['watermark_descr']['txt_fontcolor'] = 'The color of text watermark (HTML color code like #000000)';
$setting_comm['watermark_descr']['txt_bgcolor'] = 'The background color of text watermark (HTML color code like #000000)';
$setting_comm['watermark_descr']['alpha'] = 'The transparent level of watermark (0-100)';
