...
$setting_comm['gen_descr']['cache'] = '开机页面缓存，增强网站效率';
...
$setting_comm['session']['path'] = '保存路径';
...
$setting_type['web']['close'] = array("select", array("网站关闭"=>"true", "网站开启"=>"false"));
...
$setting_type['session']['path'] = array("text", false, "40");
