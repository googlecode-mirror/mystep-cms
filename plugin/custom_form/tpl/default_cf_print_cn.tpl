...
?>
			<tr>
				<td colspan="2" style="padding: 20px" align="center"><input type="button" style="padding: 20px" value="´òÓ¡ÎÄÕÂ" onclick="this.style.visibility='hidden';window.print();this.style.visibility='visible'"></td>
			</tr>
		</table>
	</div>
</div>
