...
class plugin_admin_cat implements plugin {
	public static function install() {
		...
		$db->insert($setting['db']['pre'].'admin_cat', array(0,7,$info['cat_name'],'admin_cat.php','../plugin/admin_cat/',0,0,$info['cat_desc']));
...
mystep;
	...
	public static function uninstall() {
		...
		$info = self::info();
		$db->delete($setting['db']['pre']."admin_cat",array("file","=","admin_cat.php"));
