...
class plugin_custom_sql implements plugin {
	public static function install() {
		...
		global $db, $admin_cat;
		$db->insert($setting['db']['pre'].'plugin', array(0,$info['name'],$info['idx'],$info['ver'],"plugin_custom_sql",1,$info['intro'],$info['copyright'],1,","));
		$db->insert($setting['db']['pre'].'admin_cat', array(0,7,$info['cat_name'],'custom_sql.php', '../plugin/custom_sql/', 0, 0,$info['cat_desc']));
...
mystep;
	...
	public static function uninstall() {
		...
		$info = self::info();
		$db->delete($setting['db']['pre']."admin_cat", array("file","=","custom_sql.php"));
